...
public class ClientUpdateSignListener implements PacketListener {
    ...
    public static void listener(ClientUpdateSignPacket packet) {
        Block sign = WorldManager.getWorld(Config.Spawn.WORLD).getBlock(packet.blockPosition());
        ...
        WorldManager.getWorld(Config.Spawn.WORLD).setBlock(packet.blockPosition(), sign);
    }
}
